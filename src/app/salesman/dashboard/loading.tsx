      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-6 lg:py-10 pb-24 flex flex-col gap-6 lg:gap-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
          <div className="flex flex-col gap-2">
            ...
            <div className="h-8 bg-slate-300 rounded w-64 md:w-80"></div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          {/* SalesCard Skeleton */}
          <div className="rounded-[clamp(12px,2vw,20px)] bg-white p-[clamp(20px,3vw,32px)] h-full flex flex-col justify-between min-h-[180px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-6 lg:gap-8 items-stretch">
          ...
          <div className="rounded-[clamp(12px,2vw,20px)] p-[clamp(20px,3vw,32px)] h-full min-h-[180px] flex flex-col justify-between bg-slate-100">
          ...
          <div className="rounded-[clamp(12px,2vw,20px)] p-[clamp(20px,3vw,32px)] flex flex-col min-h-[300px] bg-slate-100">
            <div className="flex justify-between items-center mb-6">
              <div className="h-5 bg-slate-200 rounded w-48"></div>
              <div className="h-3 bg-slate-200 rounded w-16"></div>
            </div>
            <div className="flex flex-col gap-4">
              <div className="h-8 border-b border-slate-200 flex items-center">
        ...
        <div className="bg-white rounded-lg border border-slate-100 p-4 min-h-[400px]">
          ...
          <div className="flex flex-col gap-4">
            ...
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="h-12 border-b border-slate-100 flex items-center px-2"
              >
